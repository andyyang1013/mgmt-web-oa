...
public class StringUtil {
    ...
    private static final char DOU_STR = ',';
    private static final String XIE_STR = "/";
    ...
    public static String toString(Object obj) {
        ...
        if (NULL_STR.equalsIgnoreCase(obj.toString())
     ...
     * 过滤设置到SQL语句中的字符串
     */
    public static String toDBFilter(String aStr) {
     ...
     * @return
     */
    public static float floatFormat(float value, int scale) {
     ...
     */
    public static Integer parseInteger(Object obj, int defaultVal) {
        try {
     ...
     * @modify
     */
    public static Long parseLongDefaultVal(String str, long defaultVal) {
        try {
     ...
     * @modify
     */
    public static Integer[] parseInteger(String[] str, int defaultVal) {
        if (str == null || str.length < 1) {
    ...
    public static String[] parseChar(char[] str) {
        if (str == null || str.length < 1) {
            return new String[0];
        }
     ...
     * @modify
     */
    public static int[] exclude(int[] src, int[] target) {
        ...
        if (tmp.length() > 1 && tmp.charAt(tmp.length() - 1) == DOU_STR) {
     ...
     * @modify
     */
    public static String[] exclude(String[] src, String[] target) {
        if (target == null || target.length < 1) {
            return src;
        }
        StringBuilder tmp = new StringBuilder();
     ...
     */
    public static String join(Object[] src, String spliter) {
     ...
     * 将指定的数组字符串使用指定的符号进行连接.
     */
    public static String join(char[] src, String spliter) {
        if (src == null || src.length < 1) {
            return "";
        }
        StringBuffer tmp = new StringBuffer();
     ...
     * 将指定的数组字符串使用指定的符号进行连接.
     */
    public static String join(int[] src, String spliter) {
        if (src == null || src.length < 1) {
            return "";
        }
        StringBuffer tmp = new StringBuffer();
     ...
     * @modify
     */
    public static String[] arround(String[] src, String str) {
        if (src == null || src.length < 1) {
            return src;
        }
    ...
    public static String mapToString(Map map) {
        ...
        if (buf.charAt(buf.length() - 1) == DOU_STR) {
     ...
     */
    public static boolean sameLength(String[]... array) {
        if (array.length <= 1) {
            return true;
        }
     ...
     * 检查指定的数组中是否包含了指定的数字.
     */
    public static boolean include(int[] source, int test) {
     ...
     */
    public static boolean include(String[] source, String test) {
        if (source == null || source.length < 1) {
            return false;
        }
     ...
     */
    public static boolean includeIgnoreCase(String[] source, String test) {
        if (source == null || source.length < 1) {
            return false;
        }
        for (String tmp : source) {
    ...
    public static String asArray(Object[] strs, String symbol) {
        ...
        for (Object o : strs) {
            if (o != null || !"".equals(o.toString())) {
                newstr += "".equals(newstr) ? o.toString() : symbol + o;
            }
        }
        return newstr;
    }
...
//	}
    ...
    public static String removeBeforeAfterDir(String data) {
        ...
        if (data.startsWith(XIE_STR)) {
            data = data.substring(1, data.length());
        }
        if (data.endsWith(XIE_STR)) {
...
//	}
     ...
     * @return
     */
    public static boolean isAllNullOrNot(String... strs) {
        ...
        if (nullCnt == 0 || nullCnt == strs.length) {
            return true;
        }
        return false;
    }
    ...
    /**
     * 判断参数列表中是否有null或有空（主要用于入参为空检测）
     * 1、只要有一个为null或者为空，则返回ture
     * 2、当全部不为null或空时，返回false
     *
     * @param objects 待检测参数
     * @return true, false
     */
        ...
        try {
            for (Object object : objects) {
                ...
                if (object instanceof String && ((String) object).trim().length() == 0) {
                    ...
                    return true;
                } else if (object instanceof HashMap && ((HashMap) object).size() == 0) {
                    return true;
                } else if (object.getClass().isArray() && Array.getLength(object) == 0) {
                    return true;
                }
            }
            //所有的参数均不为null或空时，返回false
            return false;
        } catch (Exception e) {
            return true;
        }
    ...
    public static String nullToEmpty(Object o) {
        if (null == o || "".equals(o) || NULL_STR.equals(o)) {
            return "";
        } else {
    ...
    /**
     * 判断bigDecimal百分比值在0-100间
     *
     * @param bigDecimal
     * @return
     */
    public static boolean ifPercent(BigDecimal bigDecimal) {
        BigDecimal min = new BigDecimal(0);
        BigDecimal max = new BigDecimal(100);
        if (bigDecimal == null) {
            return false;
        }
        if (min.compareTo(bigDecimal) == 1 || max.compareTo(bigDecimal) == -1) {
            return false;
        }
        return true;
    }
