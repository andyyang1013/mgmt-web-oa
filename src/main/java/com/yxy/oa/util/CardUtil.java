...
public final class CardUtil {
     ...
     * 闰年生日正则
     **/
    public static final String REGEX_BIRTHDAY_INLEAP_YEAR = "^((19[0-9]{2})|(200[0-9])|(201[0-5]))((01|03|05|07|08|10|12)(0[1-9]|[1-2][0-9]|3[0-1])|(04|06|09|11)(0[1-9]|[1-2][0-9]|30)|02(0[1-9]|[1-2][0-9]))$";
    /**
     * 平年生日正则
     **/
    public static final String REGEX_BIRTHDAY_INCOMMON_YEAR = "^((19[0-9]{2})|(200[0-9])|(201[0-5]))((01|03|05|07|08|10|12)(0[1-9]|[1-2][0-9]|3[0-1])|(04|06|09|11)(0[1-9]|[1-2][0-9]|30)|02(0[1-9]|1[0-9]|2[0-8]))$";
    ...
    private static boolean checkBirthday(String idNumberBirthdayStr) {
        ...
        if (isLeapYear(year)) {
            return Pattern.matches(REGEX_BIRTHDAY_INLEAP_YEAR, idNumberBirthdayStr);
        } else {
            return Pattern.matches(REGEX_BIRTHDAY_INCOMMON_YEAR, idNumberBirthdayStr);
        }
    }
    ...
    public static void main(String[] args) throws Throwable {
        System.out.println(CardUtil.getGenderFromPersonIDCode("11010519491231002X"));
        System.out.println(CardUtil.isIdentity("530626199109261396"));
    }
